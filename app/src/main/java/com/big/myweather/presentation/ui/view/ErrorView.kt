package com.big.myweather.presentation.ui.view
...
import com.big.myweather.databinding.ErrorViewBinding
...
class ErrorView : ConstraintLayout {
    ...
    private fun setErrorDescription(attributes: TypedArray) {
        binding.errorDescriptionTextView.text =
            attributes.getString(R.styleable.ErrorView_errorDescription)
    }
    ...
    fun addRetryButtonClickObservable(): Observable<Unit> {
        return binding.retryButton.clicks()
